...
def DataFrameTests():   
	...
	fileName = '/home/watch911/workspace/Rosetta/TEST_GMLC_Comtech.csv'
	...
	#bb.iloc[3,:] = (999, 'Brents County 911', 'BrentCS')#this saves one specific row - its not valid here as the columns do not align but it will work, see below
	...
	aa.iloc[3,:] = (999, 'Brents County 911', 'BrentCS', np.nan)#this saves one specific row. note how it saves a null - np.nan
